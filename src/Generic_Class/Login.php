...
interface IRedirectType {
    ...
    const FAILED_LOGIN_TYPE="forbid";
...
abstract class Login {
    ...
    public function redirect($IRedirectType) {
        ...
        if($this->failedLogInPage!="none" && $IRedirectType=="forbid")
            header( "Location:$this->failedLogInPage" );
    ...
    */
    protected function setAfterLogInPage($filePath){
     ...
     protected function setFailedLogInPage($filePath){
        $this->failedLogInPage=$filePath . '?status=' . IRedirectCode::FAILED_LOGIN;
    }
     ...
     * ii.   setFailedLogInPage<br>
     * iii.  setAfterLogoutInPage<br>
     * iv. setNotInSessionPage<br>
     * v.  setNoAuthorizationForModulPage<br>
     * vi.   setInvalidRightRedirectPage<br>
     * 
     */
